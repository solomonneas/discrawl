...
// discrawl emits via `discrawl export adapter`. It is a self-contained copy of
// the shared contract (the same struct shape stationtrail and sourceharvest
// carry) so MiseLedger can ingest discrawl output without a shared dependency.
package adapter
